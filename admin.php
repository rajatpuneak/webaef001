    ...
    //   $active = $row['active'];
      ...
      if($count == 1) {
        ...
        $_SESSION['login_user'] = $row['id'];
         header("location: admin_step1.php");
      }else {
			...
			<div class="row">
				...
				<div class="col-1-3">
					<div class="wrap-col item">
							<h3 class="item-header"><a href="#">Admin Login</a></h3>
						
						<span><form name="admin" id="ff" method="POST" >
										
											
											<div class="col-1-1">
												<div class="wrap-col">
													<input type="text" name="admin_id" id="admin_id" placeholder=" Enter User Id" required="required">
												</div>
											</div>
											<div class="col-2-1">
												<div class="wrap-col">
													<input type="password" name="admin_password" id="admin_password" placeholder="Enter Password" required="required">
												</div>
											</div>
